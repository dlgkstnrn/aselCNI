	...
	<main id="main" class="main">
		...
		<section class="section dashboard">
			...
			>
				...
				<div>
					<label for="start"></label> <input type="date" id="start"
						name="trip-start" value="2024-03-01" min="2024-01-01"
						max="2024-12-31"
					>&nbsp;&nbsp;~&nbsp;&nbsp;<label for="end"></label> <input
						type="date" id="end" name="trip-end" value="2024-03-07"
			...
			<!-- Start #modal -->
			<div class="modal fade show" id="ExtralargeModal" tabindex="-1"
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						...
						<div class="modal-body">Non omnis incidunt qui sed occaecati
							magni asperiores est mollitia. Soluta at et reprehenderit.
							Placeat autem numquam et fuga numquam. Tempora in facere
							consequatur sit dolor ipsum. Consequatur nemo amet incidunt est
