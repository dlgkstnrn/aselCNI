					      ...
					      <div class="col-md-8 d-flex flex-column position-static" style="padding-bottom: 1px">
					        <div class="row mb-4">
					         <!-- Example single danger button -->
					          ...
					          <button class="btn btn-primary col-3" type="button" id="searchBtn">
								                  ...
								                  <li>
								                    <div class="dropdown-item d-flex align-items-center gap-2 py-2">
								                      <div class="form-check">
								                        <input class="custCheckbox form-check-input" type="checkbox" value="${custMst.cust_cd}" id="custMst_nm">
						                ...
						                <ul class="list-unstyled mb-0">
											<c:forEach var = "userMst" items="${userMsts}" varStatus="status">
												<li>
													<div class="dropdown-item d-flex align-items-center gap-2 py-2">
								                      <div class="form-check">
								                        <input class="userCheckbox form-check-input" type="checkbox" value="${userMst.user_id}" id="user_id">
								                        <label class="form-check-label" for="flexCheckDefault">
								                          ${userMst.user_nm}
								                        </label>
								                      </div>
